...
(use-package dired-rainbow
  ...
  (dired-rainbow/def-chmod directory zent-blue     "d.*")
  (dired-rainbow/def-chmod exec      zent-green+1  "-.*x.*")
  (dired-rainbow/def partition       zent-red-2    ("bak" "bin" "dmg" "iso" "vmdk"))
  ...
  (dired-rainbow/def media           zent-blue-3   ("MP3" "MP4" "avi" "flac" "flv" "mid" "midi" "mkv" "mov" "mp3" "mp4" "mpeg" "mpg" "ogg" "wav"))
  ...
  (dired-rainbow/def compressed      zent-green-2  ("7z" "Z" "apk" "bz2" "ear" "gz" "jar" "rar" "tar" "tgz" "txz" "war" "xpi" "xz" "xz" "z" "zip" "zst"))
  (dired-rainbow/def compiled        zent-yellow   ("asm" "c" "c++" "cc" "cl" "cp" "cpp" "cs" "el" "f" "go" "h" "h++" "hi" "hpp" "hs" "hxx" "java" "lisp" "m" "rs" "s"))
  (dired-rainbow/def interpreted     zent-yellow   ("clj" "cljc" "cljs" "ipynb" "js" "mysql" "pgsql" "py" "r" "rb" "scala" "sql"))
